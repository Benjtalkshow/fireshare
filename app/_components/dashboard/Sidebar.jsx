...
const Sidebar = () => {
  ...
  return (
    <div className="hidden md:flex h-screen w-1/4 flex-col justify-between border-e bg-white">
      <div className="pb-6">
        {/* logo */}
        <Link className="flex px-4 gap-3 justify-center py-5 text-teal-600 border-b-[1px] border-b-gray-300" href={`/`} prefetch={true}>
          <svg
            className="h-8"
            viewBox="0 0 28 24"
            fill="none"
          ...
          {/* <h1 className="font-extrabold text-lg md:text-3xl">File Sharing</h1> */}
        </Link>
        ...
        <ul className="mt-6 space-y-10">
          <Link href={`/dashboard`} prefetch={true}>
            ...
            >
             <Home size={28} /> <label className="cursor-pointer">Dashboard</label>
            </li>
          </Link>
          ...
          <Link href={`/upgrade`} prefetch={true}>
            ...
            >
              <ShieldPlus size={28} /><label className="cursor-pointer">Upgrade</label>
            </li>
          </Link>
        </ul>
      </div>
      ...
      <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
        ...
        >
          ...
          <div>
            <p className="text-xs">
              <strong className="block font-medium">{user?.fullName || null}</strong>
