  ...
  return (
    <>
      {!loading ? (
        <section className="mt-[7rem]">
          <Link href={`/`} className="">
            <Button className="text-white rounded-none py-3 bg-teal-600 text-md flex mb-3 items-center gap-2 font-semibold cursor-pointer">
              <ArrowLeft size={26} />
              <label className="">FireShare</label>
            </Button>
          </Link>
          <div
          ...
          >
            <h1 className="font-bold text-xl">
              <span className="text-teal-600">{fileInfo?.userName}</span> shared
              you a file 😊
            </h1>
            <Image
              src={`/file.png`}
        ...
        <div className="w-full text-center font-semibold p-2 sm:p-5 md:p-10 lg:p-20">
          Fetching file...
        </div>
      )}
    </>
